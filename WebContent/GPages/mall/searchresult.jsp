...
<<head>
    	...
    	function getfbylike(index,fname) {
    		
    		//alert("进来！");
    		
    		var param = {"fname":fname,"index":index};
    		var tmp = "";
    		var inner = "";
    		var nullresult = "";
    		var page = "";
    		...
    		$.ajax({
    			type:'post',
    			url:'${pageContext.request.contextPath}/pagesearch',
    			data:param,
    			dataType:'json',
    			async:false,
    			success: function(data){
    				...
    				if(data.totalCount == 0){
    					biao = "<li style='font-size:22px;color:green;font-family:幼圆;margin-right:30px;'>很抱歉！查无此商品...</li>"
    				}else{
    					biao = "<li style='font-size:22px;color:green;font-family:幼圆;margin-right:30px;'>您的搜索结果如下：</li>"
						...
						if(data.totalPage==1){
							...
							page = 	"<li>最首页</li>"+
									"<li>"+data.pageCode+"</li>"+
									"<li><a id='limitdown' href='javascript:;' onclick='getfbylike(\""+down+"\",\""+fname+"\");'>下一页</a></li>"		
						}else if(data.pageCode==data.totalPage){
							page = 	"<li><a id='limitup' href='javascript:;' onclick='getfbylike(\""+up+"\",\""+fname+"\");' >上一页</a></li>"+
									"<li>"+data.pageCode+"</li>"+
									"<li>最末页</li>"
						}else{
							page = 	"<li><a id='limitup' href='javascript:;' onclick='getfbylike(\""+up+"\",\""+fname+"\");' >上一页</a></li>"+
