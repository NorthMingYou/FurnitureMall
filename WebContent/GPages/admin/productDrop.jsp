		...
		$.ajax({  
            ...
            success: function(data){ 
            	...
            	$.each(data.beanList, function (index,value){
            		...
            		if(index%2 == 0){
	            		...
	            		"<td class='center'>"+
	            		"<a href='${pageContext.request.contextPath}/dropProduct?productId="+value.fid+"' title='商品下架'>"+
	            		"<img src='${pageContext.request.contextPath}/GPages/admin/images/dropGood.png'/>"+
	            		"</a> "+
						"</td>"+
						"</tr>";
            		}
           ...
           /*  	pageCode	1
            	...
            	*/
            	...
            	{
            		pageIndex = i+1;
            		pageHtml += "<li><a style='margin-right:8px;' href='javascript:;' onclick='getProductListByState("+pageIndex+",1)'>"+pageIndex+"</a></li>";
            	}
...
<body>
	<div class="wrap">
		<div class="page-title">
			<span class="modular fl"><i></i><em>商品下架管理</em></span> 
